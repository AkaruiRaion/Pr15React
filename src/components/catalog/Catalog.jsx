            ...
            <div className={s.sort__category}>
                <div className={s.cat}>
                    ...
                    <div className={s.btns}>
                        ...
                        <buttton onClick={() => setCategory(1)} className='btn'>Химия</buttton>
                        <buttton onClick={() => setCategory(2)} className='btn'>Аксессуары</buttton>
                        <buttton onClick={() => setCategory(3)} className='btn'>Ароматизаторы</buttton>
                    </div>
                </div>
